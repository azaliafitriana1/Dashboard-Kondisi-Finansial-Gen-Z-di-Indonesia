...
st.markdown("""
    ...
    /* * (REVISI) Mengganti font utama aplikasi ke Poppins (CARA AMAN)
     * Kita tidak lagi menggunakan [class*="st-"] yang terlalu luas.
     * Kita targetkan elemen-elemen spesifik yang kita ingin ubah font-nya.
     * Ini tidak akan merusak font ikon bawaan Streamlit.
    */
    html, body, 
